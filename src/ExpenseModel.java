...
public class ExpenseModel {
    ...
    public void addExpense(Expense e) { expenses.add(e); saveExpenses(); }
    public void removeSelected() { expenses.removeIf(e -> e.selected); saveExpenses(); }
    public void clearAll() { expenses.clear(); saveExpenses(); }
    public double getTotal() { return expenses.stream().mapToDouble(e -> e.amount).sum(); }
